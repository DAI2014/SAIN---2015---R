...
hmclean1 = hm[ ave(hm$time != "", hm$time, FUN = any), ]
hmclean2 = hm2[ ave(hm2$time != "", hm2$time, FUN = any), ]
hmclean3 = hm3[ ave(hm3$time != "", hm3$time, FUN = any), ]
hmclean4 = hm4[ ave(hm4$time != "", hm4$time, FUN = any), ]

# save time series into file:
write.table(hmclean1,"hourly-male-4.ts",row.names=FALSE,sep=",")
write.table(hmclean2,"hourly-female-4.ts",row.names=FALSE,sep=",")
write.table(hmclean3,"hourly-unknown-4.ts",row.names=FALSE,sep=",")
write.table(hmclean4,"hourly-all-4.ts",row.names=FALSE,sep=",")